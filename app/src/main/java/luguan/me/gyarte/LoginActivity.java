...
public class LoginActivity extends AppCompatActivity{
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            Call<LoginResponse> call = GyarteApplication.getInstance().getApiInstance().apiService.login(new User(email, password));
